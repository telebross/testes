...
start.preload = function () {
  ...
  this.load.image('indutor', 'assets/indutor.png');
...
*/
  ...
  platforms.create(600, 455, 'bloco').setScale(2).refreshBody(); //nivel 1
  platforms.create(350, 320, 'blocolongo').setScale(2).refreshBody(); //nivel 2
  ...
  var trocacena = this.add.image(500 - 64, 400, 'iniciar', 0).setOrigin(1, 0).setInteractive();
