...
var GameScene = new Phaser.Scene("fase1");
...
GameScene.update = function () {
  ...
  /*if (portas.anims.getCurrentKey() === "saida" && //fica gerando erro nessa linha falando que não esta definido.
...
/*function collectStar(player, star, boneco) {
...
function collectStar(player, star) {
  ...
  if (stars.countActive(true) === 0) {
    ...
    var porta = portas.create(x, 500, 'saida');
    //this.physics.pause();
    //porta.setBounce(1);
